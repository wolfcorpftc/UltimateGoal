        ...
        if (tfod != null) {
            ...
            if (recognitions != null && recognitions.size() > 0) {
                switch (recognitions.get(0).getLabel()) {
                    case LABEL_SECOND_ELEMENT: return Target.B;
                    case LABEL_FIRST_ELEMENT: return Target.C;
                    default: return Target.A;
                }
            }
        }
        return Target.UNSET;
